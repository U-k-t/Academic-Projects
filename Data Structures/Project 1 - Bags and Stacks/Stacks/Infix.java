public class Infix
{
   ...
   public Infix(String expression) //Creates an Expression Equal to the Inputted String
   {
      usrExpression = expression;
   }
   public Infix () //Creates an Empty Expression
   {
      this("");
   }
   ...
   {
      String expression = "";
      VectorStack opStack = new VectorStack();
   ...
   public String toPreFix() // Converts Infix Expression to Prefix
   {
      String expression = "";
      VectorStack opStack = new VectorStack();
      VectorStack charStack = new VectorStack();
      VectorStack reversedStack = new VectorStack();
      int counter = 0;
      for (int i = 0; i<getExpression().length(); i++)
      {
   ...
   {
      VectorStack parenStack = new VectorStack();
